...
public class Exercise8_30 {
    ...
    public static double[] linearEquation(double[][] arr) {
        ...
        if ((arr[0][0] * arr[1][0]) - (arr[0][1] * arr[1][0]) == 0) {
            return null;
        }
        xandy[0] = ((arr[2][0] * arr[1][1]) - (arr[2][1] * arr[0][1])) / ((arr[0][0] * arr[1][0]) - (arr[0][1] * arr[1][0]));
        xandy[1] = ((arr[2][1] * arr[0][0]) - (arr[2][0] * arr[1][0])) / ((arr[0][0] * arr[1][0]) - (arr[0][1] * arr[1][0]));
        return xandy;
    }
